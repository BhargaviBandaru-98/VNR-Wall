      ...
      <div className="dual-section">
        <div className="section source-section">
          ...
          <div className="source-details">
            <div className="detail-row"><span className="label">Platform:</span> <span className="platform-badge">{data.platform}</span></div>
            <div className="detail-row"><span className="label">Sender:</span> <span className="sender-name">{data.sender}</span></div>
            <div className="detail-row"><span className="label">Contact:</span> <span className="contact-info">{data.contact}</span></div>
          </div>
        </div>

        <div className="section feedback-section">
          <div className="section-header"><span className="section-title">⭐ Student Feedback</span></div>
          <div className="feedback-details">
            ...
            <div className="detail-row"><span className="label">Details Shared:</span> <span className="details-shared">{data.detailsShared}</span></div>
            <div className="detail-row"><span className="label">Credibility:</span><div className="credibility-rating">{renderStars(data.credibilityRating, 5)}</div></div>
          </div>
        </div>
      </div>
